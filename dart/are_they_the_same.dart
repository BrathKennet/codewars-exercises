...
square of 121, 20736 the square of 144, 361 the square of 19, 25921 
...
bool comp(List<int> a1, List<int> a2) {
  // Iteración sobre cada elemento de la primera lista.
  for (var item in a1) {
    // Si la segunda lista no contiene el item elevado a la potencia finaliza la iteración.
    if (!a2.contains(item * item)) break;
    // Elimina el item en la segunda lista.
    a2.remove(item * item);
  }

  // Retorna si la lista es vacía.
  return a2.isEmpty;
}
